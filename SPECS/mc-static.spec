...
# Static requires
# -lc http://www.cyberciti.biz/faq/centos-rhel-redhat-usrbinld-cannot-findlc-error/
...
%build
#export CFLAGS="-D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE $RPM_OPT_FLAGS -Wno-strict-aliasing -static -static-libgcc -fno-exceptions"
export CFLAGS="-D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE $RPM_OPT_FLAGS -Wno-strict-aliasing -static"
#export CXXFLAGS=""
%configure	--with-screen=slang \
		...
		--enable-aspell \
		--enable-vfs-mcfs \
			--with-glib-static --without-x --disable-shared --enable-static \
...
%changelog
* Mon Nov 19 2012 Pavel Alexeev <Pahan@Hubbitus.info> - 4.8.6-1
- First attempt build static package by instruction - http://namelythehedgehog.wordpress.com/2010/04/20/compile-static-copy-of-midnight-commander/
