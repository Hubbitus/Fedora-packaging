...
# http://eaccelerator.net/attachment/ticket/396/eaccelerator.c.patch from http://eaccelerator.net/ticket/396
Patch2: eaccelerator-0.9.6-open_basedir.patch
...
%changelog
* Thu Mar 11 2010 Pavel Alexeev <Pahan@Hubbitus.info> - 1:0.9.6-2
- Imported from http://rpms.famillecollet.com/SRPMS/php-eaccelerator-0.9.6-1.remi.src.rpm
- Added patch2 from http://eaccelerator.net/ticket/396 ( http://eaccelerator.net/attachment/ticket/396/eaccelerator.c.patch )
- Disable %%check
