...
Libs: -L${libdir} -ljs
Cflags: -DXP_UNIX=1 -DJS_THREADSAFE=1 -I${includedir} -DJS_C_STRINGS_ARE_UTF8
EOF
...
%changelog
* Wed Sep 30 2009 Pavel Alexeev <Pahan@Hubbitus.info> - 1.70-9
- Add -DJS_C_STRINGS_ARE_UTF8 option into build as request in ml Michel Alexandre Salim.
